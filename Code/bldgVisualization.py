...
df_info = pd.read_csv(buidingInfo)#print(df)
...
# Average Retail Price for Electricity in Massachusetts is $0.185/kWh
# Source: https://www.eia.gov/electricity/state/
# Average Retail Price for Natural Gas in Massachusetts is $12.56/thousand cubic feet or $(12.26/1.036)/MMBtu
...
# ax1.set_title('Building Three Heating and Cooling Demand')
# bldg_1_heatDemand.plot()
# bldg_1_coolDemand.plot()
# plt.legend(['Heating Demand','Cooling Demand'])
# plotSaveLoc = os.path.join(
#     mainPath, 'Visualization', 'bldg3_Houly_Energy_Demand.png')
# # plt.show()
# plt.savefig(plotSaveLoc)
...
plt.title('Buiding One Monthly Utility Cost')
plt.legend(['Natural Gas','Electricity'])
plotSaveLoc = os.path.join(
    mainPath, 'Visualization', 'bldg1_Monthly_Util_Cost.png')
# plt.show()
plt.savefig(plotSaveLoc)
